...
class DynamicAgentLoader {
    ...
    formatAgentForBridge(agent) {
		...
		const config = {
			...
			pipecat_stt: agent.pipecat_stt,
			pipecat_stt_model: agent.pipecat_stt_model,
			pipecat_llm: agent.pipecat_llm,
			pipecat_llm_model: agent.pipecat_llm_model,
			pipecat_tts: agent.pipecat_tts,
			pipecat_voice: agent.pipecat_voice,
			pipecat_tts_speed: agent.pipecat_tts_speed,
